...
% Document metadata
% ------------------------------------------------------------
\title{Algorithmic Methods in \texttt{pypilot, Fenix autopilot, and ArduPilot}:\ Notes on Open Source Autopilots}
...
with primary attention to the files listed in \cref{tab:source-files}; project credit
for pypilot is checked against Sean D'Epagnier's public author page \cite{pypilot-author}.
External
...
OpenPlotter's description of \texttt{pypilot} modes, Fenix Autopilot's public repository
and documentation, and B\&G descriptions of commercial sailing autopilot operation.
