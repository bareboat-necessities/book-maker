...
% ------------------------------------------------------------
\usepackage{amsmath}
% Do NOT load amssymb or amsfonts with unicode-math.
% \usepackage{amssymb}  % conflicts with unicode-math: \eth already defined
% \usepackage{amsfonts} % unnecessary with unicode-math
...
\newcommand{\scal}[1]{#1}
% unicode-math-native bold notation
\newcommand{\vct}[1]{\symbfit{#1}}   % bold italic vector, works for Greek too
\newcommand{\mat}[1]{\symbf{#1}}     % bold upright matrix
\newcommand{\ten}[1]{\symbfsf{#1}}   % bold san
