...
% Do NOT load amssymb or amsfonts together with unicode-math.
...
\newcommand{\definedasalt}{\triangleq}
...
Vector calculus & $\grad,\divg,\curl,\Delta$ & gradient, divergence, curl, Laplacian \\
